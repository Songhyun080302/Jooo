...
const story = {
  ...
  mingu_bad:{
    speaker:"민규",
    text:"왜 그렇게 말해 ㅠㅠ<br>원우: 민규야 우리 그냥 집에 가서 쉬자<br>민규: 됐어 나 집 가서 원우형이랑 놀거야!",
    end:true
  },
  mingu_wait:{
    speaker:"민규",
    text:"응 지윤아ㅎㅎ 기다릴게ㅎㅎ<br>(벽으로 민규를 끌어당긴다)<br>민규: 지윤아! 이게 뭐하는거야",
    choices:[
  ...
  soft:{
    speaker:"지윤",
    text:"미안 많이 놀랐어? 너가 너무 귀여워서 그만..<br>(민규의 호감도 +20)<br>(그때 똑똑- 노크 소리가 다시 한번 들려왔다)<br>수진: 주지윤! 준비 다함? 데리러옴~<br>지윤: 아 맞다.. 나 오늘 쟤랑 놀기로 했었지..",
    choices:[
  ...
  sujin_love:{speaker:"수진",text:"헐.. 미친 민규를 버리고 나를 선택해 준거야..? 지윤아 나랑 사귀자♥<br>(지윤과 수진이 결혼했습니다) — END",end:true},

  // 민규 루트 이어짐
  next_city:{
    speaker:"민규",
    text:"그럼 우리 이제 시내가자!!<br>(갑자기 준휘♡송현이 등장했습니다)<br>준휘송현: 민규지윤! 너네의 그 사이좋은 모습이 너무 꼴보기 싫어! 당장 떨어지지 않으면 우리가 헤어지겠어!",
    choices:[
  ...
  love_break:{
    speaker:"나레이션",
    text:"준휘와 송현이 헤어졌다.<br>민규: 어쩔수없지 뭐ㅎㅎ 우리 밥먹으러 갈까?<br>민규: 우리 뭐 먹을까?",
    choices:[
  ...
  mingu_menu:{
    speaker:"민규",
    text:"헉 나도 그거 먹고 싶었어!<br>(그때 한 쪽에서 큰 소리가 들려왔다)<br>...: 워쓰창슈!!<br>수진: 워쓰라오후!! 진정해!!<br>호시: 워쓰창슈!!<br>민규: 에이 호시 형은 햄스터지~",
    choices:[
  ...
  agree:{
    speaker:"민규",
    text:"그치 호시는 햄스터지<br>(수진이가 배신감 어린 표정으로 쳐다보지만 민규와 공감대를 형성했습니다)<br>(밥이 나왔다)<br>민규: 지윤아 나 사실 내일 군대가..",
    choices:[
  ...
  wait_military:{
    speaker:"민규",
    text:"정말?ㅎㅎ 그럼 면회 와줄거지?<br>(3 months later... 오늘은 민규의 면회날이다)<br>지윤: 민규를 위해 고무신을 신고 가야겠어!",
    choices:[
  ...
  right_shoes:{
    speaker:"민규",
    text:"ㅎㅎ 지윤아 고무신 귀엽다 와줘서 고마워~<br>민규야 나 오늘 너한테 할말이 있어..<br>웅 뭔데?<br>민규야 사실 나..",
    choices:[
  ...
  idol:{
    speaker:"민규",
    text:"나..? 그래! 우리 사귀자!<br>(주지윤♡김민규의 사랑이 이루어졌다)<br>(few months later... 결혼 준비 중)<br>민규: 지윤아 나 머리 많이 길렀지!<br>지윤: 머리 안 자르면 파혼이야!",
    choices:[
      {text:"라푼젤", next:"rapunzel"},
      {text:"변발", next:"bye_end"}
    ]
  },
  rapunzel:{speaker:"민규",text:"지윤아ㅜㅜ 내 삶을 인정해 주는구나ㅜㅜ<br>우리 결혼해서 행복하게 살자ㅜ<br>(지윤♡민규는 결혼에 성공해서 행복하게 살았습니다) — END",end:true},
