...
const story = {
  ...
  open: {
    ...
    choices: [
      ...
      { text: "호시의 손을 잡는다", next: "hoshi_hand" }
    ]
  },

  hoshi_hand: {
    speaker: "호시",
    text: "지윤아! 나랑 놀러갈래? 민규는 나중에 만나도 돼~",
    char: "https://i.ibb.co/fQDyCZK/sample-char.png",
    choices: [
      { text: "호시와 놀러간다", next: "next_city" }
    ]
  },
  ...
  sujin_angry: {
    speaker: "수진",
    text: "미친 민규가 너랑 논다고? 호시는 어딨음? (호시를 찾아 떠났다)",
    choices: [
      { text: "계속 진행", next: "next_city" }
    ]
  },
  sujin_love: {
    speaker: "수진",
    text: "헐.. 미친 민규를 버리고 나를 선택해 준거야..? 지윤아 나랑 사귀자♥\n(지윤과 수진이 결혼했습니다) — END",
    end: true
  },
